                        ...
                        <div className="modal-content">
                            <div className="Ah-complaint-modal">
                                ...
                                <div className='  Ah-type'>
                                    <label for="complaint" className="star mb-2">Complaint Types </label>
                                    <select name="complaint" value={type} onChange={e => setType(e.target.value)} id="complaint">
                                ...
                                <div className="Ah-type">
                                    <label for="Reason" className="star mb-2">Complaint Reason </label>
                                    <textarea
                                        value={reason}
